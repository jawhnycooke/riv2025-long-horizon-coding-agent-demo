...
```bash
uv run python claude_code_agent.py --dry-run --project canopy
```
...
```bash
uv run python claude_code_agent.py --project canopy
```
...
uv run python claude_code_agent.py --project canopy --provider bedrock

# Force Anthropic API instead
uv run python claude_code_agent.py --project canopy --provider anthropic
```
